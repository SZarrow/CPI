    ...
    public class YeePaySinglePaymentService : IYeePaySinglePaymentService
    {
        ...
        public XResult<YeePaySinglePayResponse> Pay(YeePaySinglePayRequest request)
        {
            ...
            try
            {
                ...
                var respMsgResult = YeePayFundOutUtil.Execute<RawYeePaySinglePayRequest, RawYeePaySinglePayResponse>(ApiConfig.YeePay_FundOut_Pay_RequestUrl, new RawYeePaySinglePayRequest()
                {
